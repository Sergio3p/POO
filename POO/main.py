...
class SimonDice:
    ...
    def __init__(self):
        ...
        #self.__manejador.ordenarPorPuntaje()
        #self.cargarPuntajes()
        self.leerPuntajes()
    ...
    #JEISON
        ...
        self.cargarPuntajes()
        #self.__encoder.leerJSONArchivo('pysimonpuntajes.json')
        #diccionario=self.__encoder.leerJSONArchivo('datosPuntos.json')
        #self.__encoder.decodificarDiccionario(diccionario)
...
# PARA AUMENTAR DIFICULTAD
    ...
    # Crear la ventana de puntajes
        ...
        tree = ttk.Treeview(labelFramePuntajes, columns=("Nombre", "Puntaje", "Fecha", "Hora"), show='headings')
        ...
        for jugador in self.__manejador.mostrarJugador():
            ...
            tree.insert("", tk.END, values=(nombre, puntaje, fecha, hora))
